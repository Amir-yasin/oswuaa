...
class CustomUser(AbstractUser):
    ...
    user_type = models.CharField(max_length=20, choices=USER_TYPE_CHOICES)  # Added max_length
    gender = models.CharField(max_length=10, choices=GENDER_CHOICES)  # Added max_length
